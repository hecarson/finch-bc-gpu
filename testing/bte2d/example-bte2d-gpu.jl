...
# importCode("testing/bte2d/bte2dgpucode-debug")
# importCode("testing/bte2d/bte2dgpucode-bcgpu-orig")
# importCode("testing/bte2d/bte2dgpucode-bcgpu-orig-debug")
importCode("testing/bte2d/bte2dgpucode-bcgpu-newkernel")
...
solve(I)
out_file = open("bte2dgpu-sol.txt", "w")
