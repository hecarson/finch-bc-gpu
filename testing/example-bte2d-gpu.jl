...
polarizations_int = [if i == "T" i=0 else i=1 end for i in polarizations]
...
polar_coeff = coefficient("polarizations", polarizations_int, type=VAR_ARRAY)
...
# importCode("finch-gpu-test/bte2dgpucode-cpu-outgv")
# importCode("finch-gpu-test/bte2dgpucode-gpu-orig")
# importCode("finch-gpu-test/bte2dgpucode-gpu-orig-outgv")
importCode("finch-gpu-test/bte2dgpucode-gpu-newkernel")
# importCode("finch-gpu-test/bte2dgpucode-gpu-newkernel-outgv")
