function isothermal_bdry_gpu(intensity, vg, sx, sy, center_freq, polarizations, delta_freq, g20xi, g20wi, max_band, max_dir, normal, max_bi, max_fi, mesh_bdryface, mesh_face2element, mesh_bids, geometric_factors_volume, geometric_factors_area, dofs_per_node, faceCenters, dim_faceCenters, facex, t, boundary_flux, boundary_dof_index, global_vector)
@inbounds begin
