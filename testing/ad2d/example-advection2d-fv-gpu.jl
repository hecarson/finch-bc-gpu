# Note from Carson:
# The Finch examples does not have a GPU version of the advection2d example.
# This file is a GPU version that produces the same solution
...
importCode("testing/fvad2dgpucode-fix")
# importCode("testing/fvad2dgpucode-newkernel")
# importCode("testing/fvad2dgpucode-fix-outgv")
# importCode("testing/fvad2dgpucode-newkernel-outgv")
