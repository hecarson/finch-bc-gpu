...
useLog("FVbte2dgpulog-2", level=3)
...
importCode("finch-gpu/bte2dgpucode")
# importCode("finch-gpu/bte2dgpucode-gpu-newkernel")
...
println("done solving, writing temps")

outputValues(temperature, "bte2dTemp-cpu", format="vtk");
